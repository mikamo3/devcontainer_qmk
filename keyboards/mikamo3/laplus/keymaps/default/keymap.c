...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split(
        ...
        TAB_SFT, KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_LBRC,       KC_RBRC, KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN, BSH_SFT,
                 KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   GUI_H,         GUI_L,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,
                                 KC_LALT,KC_LGUI,SPC_LWR,ESC_CTL,       BSP_SFT, ENT_RSE,KC_RGUI,KC_RALT
    ),
    [_LOWER] = LAYOUT_split(
    ...
    [_RAISE] = LAYOUT_split(
        ...
        KANA,    KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______, _______,
